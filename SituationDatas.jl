...
module SituationDatas
    ...
    # ~~ ЦВЕТА ~~ 
    const BORDER_COLOR = :"#191D24" # цвет границ
    const BODY_COLOR = :"#63928b" # цвет тела робота
    const COLOR_ON_CLICK = :"#c2d6d3" # цвет тела робота при нажатии на него
    const MARKER_COLOR = :"#cc2851" # цвет маркера
    const PLOT_COLOR = :"#30334a" # цвет внешнего поля
    const INNER_COLOR = :"#383c56" # цвет внутреннего 
    const GRID_COLOR = :"#5a6887" # цвет координатных линий
